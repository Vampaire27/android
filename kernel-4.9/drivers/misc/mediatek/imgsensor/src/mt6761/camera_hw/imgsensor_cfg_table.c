...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	...
	{
		SENSOR_DRVNAME_PR2000_MIPI_YUV,
		{
			{RST, Vol_Low, 80},
			{DVDD, Vol_1200, 0},
			{RST, Vol_High, 200}
	...
	{
		SENSOR_DRVNAME_PR2001_MIPI_YUV,
		{
			{RST, Vol_Low, 80},
			{AVDD, Vol_2800, 5},
			{DVDD, Vol_1200, 0},
	...
	{
		SENSOR_DRVNAME_PR2002_MIPI_YUV,
		{
			{RST, Vol_Low, 80},
			{AVDD, Vol_2800, 5},
			{DVDD, Vol_1200, 0},
	...
	{
		SENSOR_DRVNAME_RN6752M_MIPI_YUV,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_High, 0},
			{RST, Vol_High, 0},
	...
	{
		SENSOR_DRVNAME_RN6752M1_MIPI_YUV,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_High, 0},
			{RST, Vol_High, 0},
	...
	{
		SENSOR_DRVNAME_RN6752M2_MIPI_YUV,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_High, 0},
			{RST, Vol_High, 0},
	...
	{
		SENSOR_DRVNAME_PR2100_MIPI_YUV,
		{
			{RST, Vol_Low, 80},
			{DVDD, Vol_1200, 0},
			{RST, Vol_High, 200}
