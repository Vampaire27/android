...
struct IMGSENSOR_I2C_CFG pr2100_sub_i2c;
	...
	enum   IMGSENSOR_I2C_DEV  device)
{
	...
	pr2100_sub_i2c.pinst = &gi2c.inst[IMGSENSOR_I2C_DEV_1];
	pr2100_sub_i2c.pi2c_driver = &gi2c_driver[IMGSENSOR_I2C_DEV_1];
	mutex_init(&pr2100_sub_i2c.i2c_mutex);
...
void imgsensor_i2c_filter_msg(struct IMGSENSOR_I2C_CFG *pi2c_cfg, bool en)
{
	...
	pr2100_sub_i2c.pinst->status.filter_msg = en;
}
