...
int g_camera_isAHDcam = 1;//0:720*240 1:1280*720 2:720*480 3:720*288 4:720*576
int g_camera_sig_check = 0;//0:no signal in 1:signal in
int g_aux_isAHDcam = 1;//0:720*240 1:1280*720 2:720*480 3:720*288 4:720*576
int g_aux_sig_check = 0;//0:no signal in 1:signal in
#if defined(PR2100_MIPI_YUV)
int g_user_select_360_camtype = 1;
#else
int g_user_select_360_camtype = 44;
#endif
int camera_work_status = 0x00;//close
int aux_type = -1;

enum SENSOR_ID custom_sensor_id = RN6752M;
enum IMGSENSOR_SENSOR_IDX sensor_id_flag = IMGSENSOR_SENSOR_IDX_MAIN;

#if defined(PR2000_MIPI_YUV)
extern void get_pr2000_default_param(int *brgt, int *sat, int *cont);
extern void pr2000_param_set(int mode, int para);
extern int pr2000_get_cam_type(void);
extern void pr2000_src_switch_by_user(int channel);
#endif

#if defined(PR2001_MIPI_YUV)
extern void get_pr2001_default_param(int *brgt, int *sat, int *cont);
extern void pr2001_param_set(int mode, int para);
extern int pr2001_get_cam_type(void);
extern void pr2001_src_switch_by_user(int channel);
#endif

#if defined(PR2002_MIPI_YUV)
extern void get_pr2002_default_param(int *brgt, int *sat, int *cont);
extern void pr2002_param_set(int mode, int para);
extern int pr2002_get_cam_type(void);
extern void pr2002_src_switch_by_user(int channel);
#endif

#if defined(RN6752M_MIPI_YUV)
extern void get_rn6752m_default_param(int *brgt, int *sat, int *cont);
extern void rn6752m_param_set(int mode, int para);
extern int rn6752m_get_cam_type(void);
void rn6752m_src_switch_by_user(int channel);
#endif

#if defined(RN6752M1_MIPI_YUV)
extern void get_rn6752m1_default_param(int *brgt, int *sat, int *cont);
extern void rn6752m1_param_set(int mode, int para);
extern int rn6752m1_get_cam_type(void);
void rn6752m1_src_switch_by_user(int channel);
#endif

#if defined(RN6752M2_MIPI_YUV)
extern void get_rn6752m2_default_param(int *brgt, int *sat, int *cont);
extern void rn6752m2_param_set(int mode, int para);
extern int rn6752m2_get_cam_type(void);
void rn6752m2_src_switch_by_user(int channel);
#endif


void get_camera_default_param(int *brgt, int *sat, int *cont)
{
	enum SENSOR_ID name = custom_sensor_id; 

	switch(name)
	{
#if defined(PR2000_MIPI_YUV)
		case PR2000:
			get_pr2000_default_param(brgt, sat, cont);
			break;
#endif
#if defined(PR2001_MIPI_YUV)
		case PR2001:
			get_pr2001_default_param(brgt, sat, cont);
			break;
#endif
#if defined(PR2002_MIPI_YUV)
		case PR2002:
			get_pr2002_default_param(brgt, sat, cont);
			break;
#endif
#if defined(RN6752M_MIPI_YUV)
		case RN6752M:
			get_rn6752m_default_param(brgt, sat, cont);
			break;
#endif
#if defined(RN6752M1_MIPI_YUV)
		case RN6752M1:
			get_rn6752m1_default_param(brgt, sat, cont);
			break;
#endif
#if defined(RN6752M2_MIPI_YUV)
		case RN6752M2:
			get_rn6752m2_default_param(brgt, sat, cont);
			break;
#endif
		default:
			*brgt = 128;
...
int camera_get_cam_type(void)
{
	...
	switch(name)
	{
		...
		case PR2000:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_MAIN)
				type = pr2000_get_cam_type();
			break;
#endif
#if defined(PR2001_MIPI_YUV)
		case PR2001:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_SUB)
				type = pr2001_get_cam_type();
			break;
#endif
#if defined(PR2002_MIPI_YUV)
		case PR2002:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_MAIN2)
				type = pr2002_get_cam_type();
			break;
#endif
#if defined(RN6752M_MIPI_YUV)
		case RN6752M:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_MAIN)
				type = rn6752m_get_cam_type();
			break;
#endif
#if defined(RN6752M1_MIPI_YUV)
		case RN6752M1:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_SUB)
				type = rn6752m1_get_cam_type();
			break;
#endif
#if defined(RN6752M2_MIPI_YUV)
		case RN6752M2:
			if(sensor_id_flag == IMGSENSOR_SENSOR_IDX_MAIN2)
				type = rn6752m2_get_cam_type();
			break;
#endif
		default:
			break;
	...
	printk("%s sensor_id_flag = %d, name = %d, type = %d\n",__func__,sensor_id_flag,name,type);
	return type;
}

void camera_src_switch_by_user(int channel)
{
	enum SENSOR_ID name = custom_sensor_id; 

	if(name == PR2000 || name == PR2001 || name == PR2002)
	{
#if defined(PR2000_MIPI_YUV)
		pr2000_src_switch_by_user(channel);
#endif
	}
	else if(name == RN6752M || name == RN6752M1 || name == RN6752M2)
	{
#if defined(RN6752M_MIPI_YUV)
		rn6752m_src_switch_by_user(channel);
#endif
	}
}

void camera_param_set(int mode, int para)
{
	enum SENSOR_ID name = custom_sensor_id; 
	...
	{
#if defined(PR2000_MIPI_YUV)
		pr2000_param_set(mode, para);
#endif
	}
	else if(name == RN6752M || name == RN6752M1 || name == RN6752M2)
	{
#if defined(RN6752M_MIPI_YUV)
		rn6752m_param_set(mode, para);
#endif
	}
}
...
#if defined(PR2000_MIPI_YUV)
	{PR2000_SENSOR_ID, SENSOR_DRVNAME_PR2000_MIPI_YUV, PR2000_MIPI_YUV_SensorInit},
#endif

#if defined(PR2001_MIPI_YUV)
	{PR2001_SENSOR_ID, SENSOR_DRVNAME_PR2001_MIPI_YUV, PR2001_MIPI_YUV_SensorInit},
#endif

#if defined(PR2002_MIPI_YUV)
	{PR2002_SENSOR_ID, SENSOR_DRVNAME_PR2002_MIPI_YUV, PR2002_MIPI_YUV_SensorInit},
#endif

#if defined(RN6752M_MIPI_YUV)
	{RN6752M_SENSOR_ID, SENSOR_DRVNAME_RN6752M_MIPI_YUV, RN6752M_MIPI_YUV_SensorInit},
#endif

#if defined(RN6752M1_MIPI_YUV)
	{RN6752M1_SENSOR_ID, SENSOR_DRVNAME_RN6752M1_MIPI_YUV, RN6752M1_MIPI_YUV_SensorInit},
#endif

#if defined(RN6752M2_MIPI_YUV)
	{RN6752M2_SENSOR_ID, SENSOR_DRVNAME_RN6752M2_MIPI_YUV, RN6752M2_MIPI_YUV_SensorInit},
#endif

#if defined(PR2100_MIPI_YUV)
	{PR2100_SENSOR_ID, SENSOR_DRVNAME_PR2100_MIPI_YUV, PR2100_MIPI_YUV_SensorInit},
#endif
