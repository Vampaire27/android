...
enum IMGSENSOR_RETURN imgsensor_hw_power_custom(enum IMGSENSOR_SENSOR_IDX sensor_idx, enum IMGSENSOR_HW_POWER_STATUS pwr_status, char *curr_sensor_name)
{
	return imgsensor_hw_power_custom_front(&pgimgsensor->hw,sensor_idx, pwr_status,curr_sensor_name);
}
