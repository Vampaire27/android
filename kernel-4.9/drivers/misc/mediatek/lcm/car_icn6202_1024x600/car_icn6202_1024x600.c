...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch=160;   //50  60 
	params->dsi.horizontal_frontporch=160;  //50   200
...
//for ICN6202
	icn6202_i2c_write_bytes_kernel(0x20, 0x00);
		icn6202_i2c_write_bytes_kernel(0x21, 0x58);
		icn6202_i2c_write_bytes_kernel(0x22, 0x24);
		icn6202_i2c_write_bytes_kernel(0x23, 0xA0);
		icn6202_i2c_write_bytes_kernel(0x24, 0x04);
		icn6202_i2c_write_bytes_kernel(0x25, 0xA0);		
		icn6202_i2c_write_bytes_kernel(0x26, 0x00);		
		icn6202_i2c_write_bytes_kernel(0x27, 0x28);
		icn6202_i2c_write_bytes_kernel(0x28, 0x08);
		icn6202_i2c_write_bytes_kernel(0x29, 0x28);

		icn6202_i2c_write_bytes_kernel(0x34, 0x80);
		icn6202_i2c_write_bytes_kernel(0x36, 0xA0);

		icn6202_i2c_write_bytes_kernel(0xb5, 0xA0);
		icn6202_i2c_write_bytes_kernel(0x5c, 0xFF);
		icn6202_i2c_write_bytes_kernel(0x13, 0x10);
		icn6202_i2c_write_bytes_kernel(0x56, 0x92);

		icn6202_i2c_write_bytes_kernel(0x6b, 0x31);
		icn6202_i2c_write_bytes_kernel(0x69, 0x26);

		//icn6202_i2c_write_bytes_kernel(0x10, 0x47);
		//icn6202_i2c_write_bytes_kernel(0x2a, 0x41);
        icn6202_i2c_write_bytes_kernel(0xb6, 0x20);
		icn6202_i2c_write_bytes_kernel(0x51, 0x20);

		icn6202_i2c_write_bytes_kernel(0x09, 0x10);
}
...
// ---------------------------------------------------------------------------
struct LCM_DRIVER car_icn6202_1024x600_lcm_drv =
{
	.name				= "car_icn6202_1024x600",
