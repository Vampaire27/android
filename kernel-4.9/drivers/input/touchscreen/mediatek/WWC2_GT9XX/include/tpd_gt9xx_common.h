...
//BEGIN: add by fangjie for MACRO defined
#define JNI_GET_POSITION 
#define CONFIG_GTP_CUSTOM_CFG 
#define CONFIG_GTP_HAVE_TOUCH_KEY 
#define CONFIG_GTP_USE_PINCTRL
//#define CONFIG_GTP_ESD_PROTECT  

//#define CONFIG_GTP_POWER_CTRL_SLEEP 

//#define CONFIG_GTP_DRIVER_SEND_CFG    //driver get the TP config data from config0/config1 .etc. 
                                                                       //    such as:  resulation(1024X600),
//#define CONFIG_GTP_COMPATIBLE_MODE   //use GT9271, cannot compatible GT9XXF

#define CONFIG_GTP_AUTO_UPDATE           //two update method: 1. search .bin file(/data/_goodix_update_.bin) 
                                            //                   2. use firmware data array.
//#define CONFIG_GTP_REQUEST_FW_UPDATE   //use firmware data array.

#define CONFIG_GTP_AUTO_UPDATE_CFG    //auto update config file, /data/_goodix_config_.cfg



//#define CONFIG_GTP_SUPPORT_I2C_DMA
//#define CONFIG_MTK_I2C_EXTENSION  //this MACRO is defined by kernel-3.18/drivers/misc/mediatek/i2c/Kconfig
...
//#define CONFIG_GTP_WITH_HOVER

#define CONFIG_GO_TO_RECOVERY_MODE
//END: add by fangjie for MACRO defined

//#define CONFIG_THERMAL_MONITOR
...
#endif
#define GTP_MAX_TOUCH      5  //10->5 fangjie modify

#define GTP_KEY_X_POSITION_DTS 1080
#define GTP_X_GAP_BETWEEN_SCREEN_AND_KEY 35
...
//#define TPD_KEYS        {KEY_POWER, KEY_HOMEPAGE, KEY_BACK, KEY_VOLUMEUP, KEY_VOLUMEDOWN}
//#define GTP_KEY_TAB	 {KEY_MENU, KEY_HOMEPAGE, KEY_BACK, KEY_SEND, KEY_F1, KEY_F2, KEY_F3}

//BEGIN: modify by fangjie for ShenZhenShi YunTianGe S&T CO .,LTD. Module: YTG-G10179-C1F1-B-DP has 6 keys.*/
#define TPD_KEY_COUNT  6
#define TPD_KEYS        {KEY_POWER, KEY_VOLUMEUP, KEY_VOLUMEDOWN, KEY_UNKNOWN, KEY_HOMEPAGE, KEY_BACK, }
