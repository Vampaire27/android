...
#define INFRA_CG2		0x981c7f00//0x983fff00 pwm_cg_set(1->0),pwm2_cg_set(1->0),pwm1_cg_set(1->0),pwm_hclk_cg_set(1->0)
#define INFRA_CG3		0x86947E16
#define INFRA_CG4		0x2ffc06d8//0x2ffc06d9  rg _pwm_fbclk6_ck_cg _set is pwm6(1->0)
...
#endif
unsigned int sw_cg_0_sta_read(void)
{
	return clk_readl(MODULE_SW_CG_0_STA);
}

unsigned int sw_cg_2_sta_read(void)
{
	return clk_readl(MODULE_SW_CG_2_STA);
}
...
void clkm_set(unsigned int sel, unsigned int div)		//clkm2 26M sel:0x1000 div:0x0
{
	clk_writel(CLKMON_CLK_SEL_REG, sel);
	clk_writel(CLKMON_K1_REG, div);
}
