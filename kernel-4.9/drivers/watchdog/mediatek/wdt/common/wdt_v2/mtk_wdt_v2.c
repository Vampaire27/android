...
void mtk_wd_suspend(void)
{
	...
	//BEGIN: add by fangjie for send the ARM sleep status to mcu. 
	arm_sleep_status_indicator(1);
	pr_debug("fangjie : send ARM LP_STATUS 1 to MCU\n");
	//END: add by fangjie for send the ARM sleep status to mcu. 
